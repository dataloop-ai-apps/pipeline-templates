# *CLIP Preprocessing for Fine-tuning* Template
...
dataset. This template prepares the data for fine-tuning with CLIP.

### Preparation

To be able to train CLIP, you need to have two datasets: one for images and one for the image and text pairs in 
prompt items. Create two datasets, and upload all images to one of them.
